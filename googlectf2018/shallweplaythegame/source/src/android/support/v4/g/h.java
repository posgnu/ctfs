...
abstract class h
{
        ...
        implements Set
    {
        ...
        public boolean contains(Object obj)
        {
            if (obj instanceof java.util.Map.Entry)
            {
                ...
                if (i >= 0)
                {
                    return android.support.v4.g.c.a(a.a(i, 1), ((java.util.Map.Entry) (obj)).getValue());
                }
            }
            return false;
        }
        ...
        implements Set
    {
        ...
        public boolean removeAll(Collection collection)
        {
            return h.b(a.b(), collection);
        }

        public boolean retainAll(Collection collection)
        {
            return h.c(a.b(), collection);
        }
        ...
        implements Iterator, java.util.Map.Entry
    {
        ...
        public final boolean equals(Object obj)
        {
            ...
            obj = (java.util.Map.Entry)obj;
            if (!android.support.v4.g.c.a(((java.util.Map.Entry) (obj)).getKey(), d.a(b, 0)) || !android.support.v4.g.c.a(((java.util.Map.Entry) (obj)).getValue(), d.a(b, 1)))
            {
                flag = false;
            }
            return flag;
