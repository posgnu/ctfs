    ...
    implements android.view.View.OnClickListener
{
    private static final class a
    {
        ...
        public a(View view)
        {
            ...
            e = (ImageView)view.findViewById(android.support.v7.a.a.f.edit_query);
        }
    }
    ...
    public aq(Context context, SearchView searchview, SearchableInfo searchableinfo, WeakHashMap weakhashmap)
    {
    ...
    {
        if (s1 != null && !s1.isEmpty() && !"0".equals(s1)) goto _L2; else goto _L1
_L1:
        Object obj = null;
_L4:
        return ((Drawable) (obj));
_L2:
        ...
        obj = android.support.v4.b.a.a(m, i);
        a(s2, ((Drawable) (obj)));
        return ((Drawable) (obj));
        Object obj1;
        obj1;
...
_L1:
    ...
    private CharSequence b(CharSequence charsequence)
    {
        if (r == null)
        {
            ...
            d.getTheme().resolveAttribute(android.support.v7.a.a.a.textColorSearchUrl, typedvalue, true);
    ...
    public View a(Context context, Cursor cursor, ViewGroup viewgroup)
    {
        ...
        ((ImageView)context.findViewById(android.support.v7.a.a.f.edit_query)).setImageResource(o);
        return context;
    }
