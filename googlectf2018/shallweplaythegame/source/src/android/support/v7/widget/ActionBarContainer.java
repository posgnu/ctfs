...
public class ActionBarContainer extends FrameLayout
{
    ...
    public ActionBarContainer(Context context, AttributeSet attributeset)
    {
        ...
        p.a(this, ((Drawable) (obj)));
        context = context.obtainStyledAttributes(attributeset, android.support.v7.a.a.j.ActionBar);
        a = context.getDrawable(android.support.v7.a.a.j.ActionBar_background);
        b = context.getDrawable(android.support.v7.a.a.j.ActionBar_backgroundStacked);
        j = context.getDimensionPixelSize(android.support.v7.a.a.j.ActionBar_height, -1);
        if (getId() == android.support.v7.a.a.f.split_action_bar)
        {
            d = true;
            c = context.getDrawable(android.support.v7.a.a.j.ActionBar_backgroundSplit);
        }
        context.recycle();
        if (d)
        {
...
_L3:
    ...
    public void setTabContainer(ap ap1)
    {
        if (g != null)
        {
            removeView(g);
        ...
        {
            addView(ap1);
            android.view.ViewGroup.LayoutParams layoutparams = ap1.getLayoutParams();
            layoutparams.width = -1;
            layoutparams.height = -2;
            ap1.setAllowCollapse(false);
        }
    }
