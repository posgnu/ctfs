...
.method private prepareMenuItems()V
    ...
    iget-boolean v0, v0, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuAdapter;->mUpdateSuspended:Z
    ...
    iput-boolean v0, v1, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuAdapter;->mUpdateSuspended:Z
    ...
    new-instance v17, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuHeaderItem;

    const/16 v18, 0x0

    invoke-direct/range {v17 .. v18}, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuHeaderItem;-><init>(Landroid/support/design/internal/NavigationMenuPresenter$1;)V
    ...
    .line 464
    .local v4, "currentGroupStart":I
    const/4 v2, 0x0

    .line 465
    .local v2, "currentGroupHasIcon":Z
    const/4 v6, 0x0
    ...
    invoke-static/range {v16 .. v16}, Landroid/support/design/internal/NavigationMenuPresenter;->access$000(Landroid/support/design/internal/NavigationMenuPresenter;)Landroid/support/v7/view/menu/MenuBuilder;

    move-result-object v16

    invoke-virtual/range {v16 .. v16}, Landroid/support/v7/view/menu/MenuBuilder;->getVisibleItems()Ljava/util/ArrayList;
    ...
    invoke-virtual {v7}, Landroid/support/v7/view/menu/MenuItemImpl;->isChecked()Z
    ...
    invoke-virtual {v0, v7}, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuAdapter;->setCheckedItem(Landroid/support/v7/view/menu/MenuItemImpl;)V

    .line 470
    :cond_1
    invoke-virtual {v7}, Landroid/support/v7/view/menu/MenuItemImpl;->isCheckable()Z
    ...
    invoke-virtual {v7, v0}, Landroid/support/v7/view/menu/MenuItemImpl;->setExclusiveCheckable(Z)V
    ...
    new-instance v17, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuSeparatorItem;
    ...
    invoke-direct/range {v17 .. v19}, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuSeparatorItem;-><init>(II)V
    ...
    new-instance v17, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuTextItem;
    ...
    invoke-direct {v0, v7, v1}, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuTextItem;-><init>(Landroid/support/v7/view/menu/MenuItemImpl;Landroid/support/design/internal/NavigationMenuPresenter$1;)V
    ...
    .line 483
    invoke-interface {v10, v8}, Landroid/view/SubMenu;->getItem(I)Landroid/view/MenuItem;
    ...
    .line 484
    .local v12, "subMenuItem":Landroid/support/v7/view/menu/MenuItemImpl;
    invoke-virtual {v12}, Landroid/support/v7/view/menu/MenuItemImpl;->isVisible()Z
    ...
    invoke-virtual {v12}, Landroid/support/v7/view/menu/MenuItemImpl;->getIcon()Landroid/graphics/drawable/Drawable;
    ...
    .line 488
    :cond_4
    invoke-virtual {v12}, Landroid/support/v7/view/menu/MenuItemImpl;->isCheckable()Z
    ...
    invoke-virtual {v12, v0}, Landroid/support/v7/view/menu/MenuItemImpl;->setExclusiveCheckable(Z)V
    ...
    invoke-direct {v0, v12, v1}, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuTextItem;-><init>(Landroid/support/v7/view/menu/MenuItemImpl;Landroid/support/design/internal/NavigationMenuPresenter$1;)V
    ...
    .line 497
    .end local v12    # "subMenuItem":Landroid/support/v7/view/menu/MenuItemImpl;
    :cond_8
    if-eqz v11, :cond_9
    ...
    invoke-direct {v0, v13, v1}, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuAdapter;->appendTransparentIconIfMissing(II)V
    ...
    .line 505
    invoke-virtual {v7}, Landroid/support/v7/view/menu/MenuItemImpl;->getIcon()Landroid/graphics/drawable/Drawable;
    ...
    invoke-static/range {v19 .. v19}, Landroid/support/design/internal/NavigationMenuPresenter;->access$1100(Landroid/support/design/internal/NavigationMenuPresenter;)I
    ...
    invoke-direct {v14, v7, v0}, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuTextItem;-><init>(Landroid/support/v7/view/menu/MenuItemImpl;Landroid/support/design/internal/NavigationMenuPresenter$1;)V

    .line 516
    .local v14, "textItem":Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuTextItem;
    iput-boolean v2, v14, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuTextItem;->needsEmptyIcon:Z
    ...
    .line 505
    .end local v14    # "textItem":Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuTextItem;
    :cond_c
    const/4 v2, 0x0
    ...
    invoke-direct {v0, v4, v1}, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuAdapter;->appendTransparentIconIfMissing(II)V
