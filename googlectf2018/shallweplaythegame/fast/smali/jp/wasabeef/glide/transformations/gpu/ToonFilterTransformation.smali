...
.method public constructor <init>(Landroid/content/Context;Lcom/bumptech/glide/load/engine/bitmap_recycle/BitmapPool;FF)V
    ...
    .param p4, "quantizationLevels"    # F

    .prologue
    .line 48
    new-instance v1, Ljp/co/cyberagent/android/gpuimage/GPUImageToonFilter;

    invoke-direct {v1}, Ljp/co/cyberagent/android/gpuimage/GPUImageToonFilter;-><init>()V
    ...
    check-cast v0, Ljp/co/cyberagent/android/gpuimage/GPUImageToonFilter;

    .line 52
    .local v0, "filter":Ljp/co/cyberagent/android/gpuimage/GPUImageToonFilter;
    iget v1, p0, Ljp/wasabeef/glide/transformations/gpu/ToonFilterTransformation;->mThreshold:F

    invoke-virtual {v0, v1}, Ljp/co/cyberagent/android/gpuimage/GPUImageToonFilter;->setThreshold(F)V

    .line 53
    iget v1, p0, Ljp/wasabeef/glide/transformations/gpu/ToonFilterTransformation;->mQuantizationLevels:F

    invoke-virtual {v0, v1}, Ljp/co/cyberagent/android/gpuimage/GPUImageToonFilter;->setQuantizationLevels(F)V
