...
.field final zzasW:Ljava/util/ArrayList;
...
.method constructor <init>(ILjava/lang/String;Ljava/util/ArrayList;)V
    ...
    iput-object p3, p0, Lcom/google/android/gms/common/server/response/FieldMappingDictionary$Entry;->zzasW:Ljava/util/ArrayList;
...
.method constructor <init>(Ljava/lang/String;Ljava/util/Map;)V
    ...
    invoke-static {p2}, Lcom/google/android/gms/common/server/response/FieldMappingDictionary$Entry;->zzT(Ljava/util/Map;)Ljava/util/ArrayList;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/gms/common/server/response/FieldMappingDictionary$Entry;->zzasW:Ljava/util/ArrayList;

    return-void
.end method

.method private static zzT(Ljava/util/Map;)Ljava/util/ArrayList;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method zzuu()Ljava/util/HashMap;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/server/response/FieldMappingDictionary$Entry;->zzasW:Ljava/util/ArrayList;
    ...
    iget-object v4, v0, Lcom/google/android/gms/common/server/response/FieldMappingDictionary$FieldMapPair;->zzaB:Ljava/lang/String;

    iget-object v0, v0, Lcom/google/android/gms/common/server/response/FieldMappingDictionary$FieldMapPair;->zzasX:Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;
