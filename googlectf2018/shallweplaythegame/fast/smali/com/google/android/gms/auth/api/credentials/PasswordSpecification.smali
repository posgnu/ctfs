...
.field public static final zzabL:Lcom/google/android/gms/auth/api/credentials/PasswordSpecification;

.field public static final zzabM:Lcom/google/android/gms/auth/api/credentials/PasswordSpecification;


# instance fields
.field final mVersionCode:I

.field final zzabN:Ljava/lang/String;

.field final zzabO:Ljava/util/List;
...
.field final zzabP:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.field private final zzabS:[I

.field private final zzvQ:Ljava/util/Random;
...
.method static constructor <clinit>()V
    ...
    invoke-virtual {v0, v1}, Lcom/google/android/gms/auth/api/credentials/PasswordSpecification$zza;->zzck(Ljava/lang/String;)Lcom/google/android/gms/auth/api/credentials/PasswordSpecification$zza;
    ...
    invoke-virtual {v0}, Lcom/google/android/gms/auth/api/credentials/PasswordSpecification$zza;->zzoZ()Lcom/google/android/gms/auth/api/credentials/PasswordSpecification;

    move-result-object v0

    sput-object v0, Lcom/google/android/gms/auth/api/credentials/PasswordSpecification;->zzabL:Lcom/google/android/gms/auth/api/credentials/PasswordSpecification;
    ...
    sput-object v0, Lcom/google/android/gms/auth/api/credentials/PasswordSpecification;->zzabM:Lcom/google/android/gms/auth/api/credentials/PasswordSpecification;
...
.method constructor <init>(ILjava/lang/String;Ljava/util/List;Ljava/util/List;II)V
    ...
    iput-object p2, p0, Lcom/google/android/gms/auth/api/credentials/PasswordSpecification;->zzabN:Ljava/lang/String;

    invoke-static {p3}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/gms/auth/api/credentials/PasswordSpecification;->zzabO:Ljava/util/List;

    invoke-static {p4}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/gms/auth/api/credentials/PasswordSpecification;->zzabP:Ljava/util/List;

    iput p5, p0, Lcom/google/android/gms/auth/api/credentials/PasswordSpecification;->zzabQ:I

    iput p6, p0, Lcom/google/android/gms/auth/api/credentials/PasswordSpecification;->zzabR:I

    invoke-direct {p0}, Lcom/google/android/gms/auth/api/credentials/PasswordSpecification;->zzoY()[I

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/gms/auth/api/credentials/PasswordSpecification;->zzabS:[I

    new-instance v0, Ljava/security/SecureRandom;

    invoke-direct {v0}, Ljava/security/SecureRandom;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/auth/api/credentials/PasswordSpecification;->zzvQ:Ljava/util/Random;
...
.method private zzoY()[I
    ...
    iget-object v0, p0, Lcom/google/android/gms/auth/api/credentials/PasswordSpecification;->zzabO:Ljava/util/List;
