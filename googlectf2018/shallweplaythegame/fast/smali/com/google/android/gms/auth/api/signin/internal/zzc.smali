...
.method private zza(Lcom/google/android/gms/common/api/GoogleApiClient;Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;)Lcom/google/android/gms/common/api/OptionalPendingResult;
    ...
    invoke-direct {v1, v0}, Lcom/google/android/gms/internal/zzox;-><init>(Lcom/google/android/gms/common/api/PendingResult;)V
...
.method private zzb(Lcom/google/android/gms/common/api/GoogleApiClient;)Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;
    ...
    sget-object v0, Lcom/google/android/gms/auth/api/Auth;->zzabn:Lcom/google/android/gms/common/api/Api$zzf;
    ...
    invoke-virtual {v0}, Lcom/google/android/gms/auth/api/signin/internal/zzd;->zzpu()Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;
...
.method public getSignInIntent(Lcom/google/android/gms/common/api/GoogleApiClient;)Landroid/content/Intent;
    ...
    invoke-virtual {v0}, Lcom/google/android/gms/auth/api/signin/internal/zzd;->zzpt()Landroid/content/Intent;
...
.method public revokeAccess(Lcom/google/android/gms/common/api/GoogleApiClient;)Lcom/google/android/gms/common/api/PendingResult;
    ...
    invoke-static {}, Lcom/google/android/gms/common/api/GoogleApiClient;->zzrq()Ljava/util/Set;
    ...
    invoke-virtual {v0}, Lcom/google/android/gms/common/api/GoogleApiClient;->zzrr()V
...
.method public zza(Landroid/content/Context;Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;)Lcom/google/android/gms/auth/api/signin/GoogleSignInResult;
    ...
    invoke-static {p1}, Lcom/google/android/gms/auth/api/signin/internal/zzk;->zzab(Landroid/content/Context;)Lcom/google/android/gms/auth/api/signin/internal/zzk;

    move-result-object v1

    invoke-virtual {v1}, Lcom/google/android/gms/auth/api/signin/internal/zzk;->zzpD()Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;
    ...
    invoke-virtual {p2}, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->zzpl()Z

    move-result v3

    if-nez v3, :cond_0

    invoke-virtual {p2}, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->zzpk()Z

    move-result v3

    if-eqz v3, :cond_2

    invoke-virtual {v2}, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->zzpk()Z

    move-result v3

    if-eqz v3, :cond_0

    invoke-virtual {p2}, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->zzpn()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v2}, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->zzpn()Ljava/lang/String;
    ...
    invoke-virtual {v2}, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->zzpj()Ljava/util/ArrayList;
    ...
    invoke-virtual {p2}, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->zzpj()Ljava/util/ArrayList;
    ...
    invoke-virtual {v1}, Lcom/google/android/gms/auth/api/signin/internal/zzk;->zzpC()Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;
