...
class Instruction:
    ...
    def tostring(self):
        ...
        ConditionD = { 0: "n", 1: "e", 2: "l", 3: "le", 4: "g", 5: "ge", 6: "no", 7: "o", 8: "ns", 9: "s", 10: "sl",
                       11: "sle", 12: "sg", 13: "sge", 14: "Wrong", 15: "" }
    ...
    def jumpto(self):
        # If Call / Branch, returns the address
        if self.Loc != -1:
            return self.Loc
    ...
    def isblockend(self):
        if self.type in ["RE", "HT"]: # Return or Halt
            return True
        elif self.type in ["B", "BR", "BRA", "BRR"]: # Branches
            return True
        else:
            return False
...
def loadfile(filename):
    ...
    print("Total " + str(len(data)) + "(" + hex(len(data)) + ") cLEMENCy byte(s) read.")
    return data
